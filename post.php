   ...
   { 
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST") 
		{
			...
			$post_content_cont   =  $_REQUEST['post_content_cont'];
				...
				//post_2nd_img
				if (isset($_REQUEST['post_2nd_img']))
				{
					$post_2nd_imgErr="This is Required"; 
				}		
				else
				{
				// Set image placement folder
						...
						{
						   $post_2nd_imgErr = "Select image to upload";
				...
				move_uploaded_file($_FILES["post_1st_img"]["tmp_name"], $post_1st_img);
				move_uploaded_file($_FILES["post_2nd_img"]["tmp_name"], $post_2nd_img);
				$date_created= date ("F jS, Y");
				$date_updated = date ("F jS, Y");
		     	$query = "INSERT INTO blogs (date_created,post_title,post_category,sub_category,post_main_img,post_content_body,post_quote,post_1st_img,post_2nd_img,post_content_cont,date_updated,post_created_by) 
				VALUES ('$date_created','$post_title','$post_category','$sub_category','$post_main_img','$post_content_body','$post_quote','$post_1st_img','$post_2nd_img','$post_content_cont','$date_updated','$universal_user_id')";
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="single_img top-buffer">
														...
														<input type="file" name="post_1st_img"     required>
												...
												<div class="col-sm-6">
													<div class="single_img top-buffer">
														...
														<input type="file" name="post_2nd_img"     required>
